        ...
        <?php foreach ($articles as $article): ?>
            <div class="article-card">
                <?php if (!empty($article['imageUrl'])): ?>
                    <img
                        src="<?= htmlspecialchars($article['imageUrl'], ENT_QUOTES, 'UTF-8') ?>"
                        width="200"
                        alt="<?= htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8') ?>"
                    >
                <?php endif; ?>
                <h2><a href="<?= htmlspecialchars($article['url'], ENT_QUOTES, 'UTF-8') ?>" target="_blank"><?= htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8') ?></a></h2>
